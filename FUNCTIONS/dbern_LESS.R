...
#### 1.Density functions ####
dbern_LESS <- nimbleFunction(run = function( x = double(1),
                                             pZero = double(0),
                                             sigma = double(0),
                                             d2 = double(1),
...
rbern_LESS <- nimbleFunction(run = function( n = integer(0),
                                             pZero = double(0),
                                             sigma = double(0),
                                             d2 = double(1),
                                             maxDist = double(0, default = 0.0),
...
registerDistributions(list(
   dbern_LESS = list(
      BUGSdist = "dbern_LESS(pZero, sigma, d2, maxDist, indicator)",
