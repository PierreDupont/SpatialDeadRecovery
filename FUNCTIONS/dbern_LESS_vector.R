...
#'
#' @description
#' \code{dbern_LESS_vector} returns the likelihood of a given spatial detection history y[i,1:n.detectors] 
#'
...
#### 1.Density functions ####
dbern_LESS_vector <- nimbleFunction(run = function( x = double(1),
                                                    pZero = double(1),
                                                    sigma = double(0),
                                                    d2 = double(1),
...
rbern_LESS_vector <- nimbleFunction(run = function( n = integer(0),
                                                    pZero = double(1),
                                                    sigma = double(0),
                                                    d2 = double(1),
                                                    maxDist = double(0, default = 0.0),
...
registerDistributions(list(
   dbern_LESS_vector = list(
      BUGSdist = "dbern_LESS_vector(pZero, sigma, d2, maxDist, indicator)",
