...
#' MyDensityRaster <- SimulateAutocorrelatedRaster(habitat.list=myHabitat.list
#'                                                  , NRaster=1
#'                                                  , phi = 0.1
#'                                                  , scaled = T
#'                                                  , focal = NULL
...
SimulateAutocorrelatedRaster <- function(  habitat.list = habitat.list
                                         , NRaster = 1
                                         ,  phi = 1 
                                         , scaled = FALSE
                                         , focal = NULL
  ...
  distance <- gDistance(habitat.list$habitat.sp, habitat.list$habitat.sp, byid = T)
  ...
  r[[i]] <- rasterFromXYZ(cbind(coordinates(habitat.list$habitat.sp), X))
