...
#### 1.Density function ####
dbin_LESS_vector <- nimbleFunction(run = function( x = double(1)
                                            , pZero = double(1)
                                            , sigma = double(0)
                                            , trials = double(1)
                                            , d2 = double(1)
...
#### 2.Sampling function ####
rbin_LESS_vector <- nimbleFunction(run = function( n = integer(0)
                                            , pZero = double(1)
                                            , sigma = double(0)
                                            , trials = double(1)
                                            , d2 = double(1)
...
registerDistributions(list(
  dbin_LESS_vector = list(
    BUGSdist = "dbin_LESS_vector (pZero, sigma, trials, d2, maxDist, indicator)",
    types = c( "value = double(1)", "pZero = double(1)", "sigma = double(0)", "trials = double(1)", "d2 = double(1)", 
